...
const ImageEditor = ({
  ...
  setSettings: React.Dispatch<
    React.SetStateAction<{ type: 'original' | 'wide' | 'square'; sensitive: boolean }>
  >;
}) => {
      ...
      <div className="bg-black rounded-xl  p-12 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between text-sm">
          <div className="flex items-center gap-8">
            <div
              className="flec items-center gap-2 cursor-pointer"
            ...
            <div
              ...
              <svg width={24} viewBox="0 0 24 24">
                <path
                  className={settings.type === 'wide' ? 'fill-iconBlue' : 'fill-[#e7e9ea]'}
            ...
            <div
              ...
              <svg width={24} viewBox="0 0 24 24">
                <path
                  className={settings.type === 'square' ? 'fill-iconBlue' : 'fill-[#e7e9ea]'}
